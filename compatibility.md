...
| --- | --- | --- | --- |
| `@anthropic-ai/sdk` | 0.33.0 | 0.109.0 | 13.19.0 |
| `@apollo/gateway` | 2.3.0 | 2.14.2 | 14.0.0 |
| `@apollo/server` | 4.0.0 | 5.5.1 | 14.0.0 |
| `@aws-sdk/client-bedrock-runtime` | 3.377.0 | 3.1077.0 | 11.13.0 |
| `@aws-sdk/client-dynamodb` | 3.377.0 | 3.1077.0 | 8.7.1 |
| `@aws-sdk/client-sns` | 3.377.0 | 3.1077.0 | 8.7.1 |
| `@aws-sdk/client-sqs` | 3.377.0 | 3.1077.0 | 8.7.1 |
| `@aws-sdk/lib-dynamodb` | 3.377.0 | 3.1077.0 | 8.7.1 |
...
| `@smithy/smithy-client` | 2.0.0 | 4.14.4 | 11.0.0 |
