...
const shimmer = (module.exports = {
  ...
  setupCustomSubscriber: function setupCustomSubscriber(agent, moduleName, config) {
    const instrumentations = []

    config.instrumentations.forEach((instrumentation) => {
      const { functionQuery, events, handlers } = instrumentation
      const targetName =
      ...
      const CustomSubscriber = createCustomSubscriber({ channelName, events, handlers })
