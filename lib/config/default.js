...
defaultConfig.definition = () => {
  return {
    ...
    /**
     * The trusted account key used to validate incoming distributed trace
     * headers. Only used in serverless_mode; defaults to account_id when
     * account_id is set. Locally configured values are ignored outside
     * serverless_mode.
     */
    trusted_account_key: {
      default: null
    ...
    /**
     * The APM application ID to attribute serverless trace data to. Only
     * used in serverless_mode; defaults to 'Unknown' when account_id is
     * set. Locally configured values are ignored outside serverless_mode.
     */
    primary_application_id: {
      default: null
    },
    /**
     * The New Relic account ID to attribute serverless trace data to. Only
     * used in serverless_mode; required for distributed tracing to be
     * enabled there. Locally configured values are ignored outside
     * serverless_mode.
     */
    account_id: {
      default: null
    ...
    /**
     * Stanza for customizing behavior for Kafka instrumentation
     */
    kafka: {
      metrics: {
        cluster: {
