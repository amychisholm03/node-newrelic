...
const createSegmentInContext = require('../context-manager/create-segment.js')
...
class Subscriber {
  ...
  createSegment({ name, recorder, ctx, attributes = null }) {
    ...
    this.addAttributes(newCtx.segment, attributes)
    return newCtx
  }
  ...
  /**
   * Handles injecting w3c tracecontext in outgoing headers.
   *
