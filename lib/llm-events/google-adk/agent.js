...
/**
 * Encapsulates a Google ADK LlmAgent event.
 */
module.exports = class GoogleAdkLlmAgent extends LlmEvent {
  /**
  ...
  constructor({ agent, segment, transaction, aiAgentName, error }) {
    super({ agent, segment, transaction, vendor: 'google_adk', error })
